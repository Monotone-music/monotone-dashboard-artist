...
import { getPendingTracks, Track } from "@/service/managerService";
          ...
          <TableBody>
            {tracks.map((track) => (
              <TableRow key={track._id}>
                <TableCell>{track.position.no}/{track.position.of}</TableCell>
                ...
                <TableCell className="capitalize text-orange-500">{track.available}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
