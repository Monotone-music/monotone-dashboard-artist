...
const AuthInput:React.FC<AuthInputProps> = ({showLabel = true,label,register, type, placeholder, id, error}) => {
  return (
    <div className={styles['input-container']}>
      {showLabel && (<label htmlFor={id} className={styles.label}>{label}</label>)}
